...
enum opt_code
{
  ...
  OPT_mbranch_cost_ = 1073,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1074,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1075,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1076,                /* -mcode-readable= */
  OPT_mdebug = 1077,                         /* -mdebug */
  OPT_mdebugd = 1078,                        /* -mdebugd */
  OPT_mdivide_breaks = 1079,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1080,                  /* -mdivide-traps */
  OPT_mdmx = 1081,                           /* -mdmx */
  OPT_mdouble_float = 1082,                  /* -mdouble-float */
  OPT_mdsp = 1083,                           /* -mdsp */
  OPT_mdspr2 = 1084,                         /* -mdspr2 */
  OPT_meb = 1085,                            /* -meb */
  OPT_mel = 1086,                            /* -mel */
  OPT_membedded_data = 1087,                 /* -membedded-data */
  OPT_meva = 1088,                           /* -meva */
  OPT_mexplicit_relocs = 1089,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1090,                  /* -mextern-sdata */
  OPT_mfix_24k = 1091,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1092,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1093,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1094,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1095,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1096,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1097,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1098,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1099,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1100,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1101,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1102,                 /* -mfp-exceptions */
  OPT_mfp32 = 1103,                          /* -mfp32 */
  OPT_mfp64 = 1104,                          /* -mfp64 */
  OPT_mfused_madd = 1105,                    /* -mfused-madd */
  OPT_mgp32 = 1106,                          /* -mgp32 */
  OPT_mgp64 = 1107,                          /* -mgp64 */
  OPT_mgpopt = 1108,                         /* -mgpopt */
  OPT_mhard_float = 1109,                    /* -mhard-float */
  OPT_mimadd = 1110,                         /* -mimadd */
  OPT_minterlink_compressed = 1111,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1112,              /* -minterlink-mips16 */
  OPT_mips = 1113,                           /* -mips */
  OPT_mips16 = 1114,                         /* -mips16 */
  OPT_mips3d = 1115,                         /* -mips3d */
  OPT_mllsc = 1116,                          /* -mllsc */
  OPT_mlocal_sdata = 1117,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1118,                    /* -mlong-calls */
  OPT_mlong32 = 1119,                        /* -mlong32 */
  OPT_mlong64 = 1120,                        /* -mlong64 */
  OPT_mmad = 1121,                           /* -mmad */
  OPT_mmcount_ra_address = 1122,             /* -mmcount-ra-address */
  OPT_mmcu = 1123,                           /* -mmcu */
  OPT_mmemcpy = 1124,                        /* -mmemcpy */
  OPT_mmicromips = 1125,                     /* -mmicromips */
  OPT_mmt = 1126,                            /* -mmt */
  OPT_mnan_ = 1127,                          /* -mnan= */
  OPT_mno_float = 1128,                      /* -mno-float */
  OPT_mno_flush_func = 1129,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1130,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1131,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1132,                     /* -mno-mips3d */
  OPT_mpaired_single = 1133,                 /* -mpaired-single */
  OPT_mplt = 1134,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1135,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1136,               /* -mrelax-pic-calls */
  OPT_mshared = 1137,                        /* -mshared */
  OPT_msingle_float = 1138,                  /* -msingle-float */
  OPT_msmartmips = 1139,                     /* -msmartmips */
  OPT_msoft_float = 1140,                    /* -msoft-float */
  OPT_msplit_addresses = 1141,               /* -msplit-addresses */
  OPT_msym32 = 1142,                         /* -msym32 */
  OPT_msynci = 1143,                         /* -msynci */
  OPT_mtune_ = 1144,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1145,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1146,                          /* -mvirt */
  OPT_mvr4130_align = 1147,                  /* -mvr4130-align */
  OPT_mxgot = 1148,                          /* -mxgot */
  OPT_n = 1149,                              /* -n */
  OPT_no_canonical_prefixes = 1150,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1151,              /* -no-integrated-cpp */
  OPT_noasmopt = 1152,                       /* -noasmopt */
  OPT_nocpp = 1153,                          /* -nocpp */
  OPT_nodefaultlibs = 1154,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1155,                   /* -nostartfiles */
  OPT_nostdinc = 1156,                       /* -nostdinc */
  OPT_nostdinc__ = 1157,                     /* -nostdinc++ */
  OPT_nostdlib = 1158,                       /* -nostdlib */
  OPT_o = 1159,                              /* -o */
  OPT_p = 1160,                              /* -p */
  OPT_pass_exit_codes = 1161,                /* -pass-exit-codes */
  /* OPT_pedantic = 1162, */                 /* -pedantic */
  OPT_pedantic_errors = 1163,                /* -pedantic-errors */
  OPT_pg = 1164,                             /* -pg */
  OPT_pie = 1165,                            /* -pie */
  OPT_pipe = 1166,                           /* -pipe */
  OPT_print_file_name_ = 1167,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1168,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1169,          /* -print-multi-directory */
  OPT_print_multi_lib = 1170,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1171,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1172,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1173,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1174,               /* -print-prog-name= */
  OPT_print_search_dirs = 1175,              /* -print-search-dirs */
  OPT_print_sysroot = 1176,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1177,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1178,                          /* -quiet */
  OPT_r = 1179,                              /* -r */
  OPT_remap = 1180,                          /* -remap */
  OPT_s = 1181,                              /* -s */
  OPT_s_bc_abi = 1182,                       /* -s-bc-abi */
  OPT_save_temps = 1183,                     /* -save-temps */
  OPT_save_temps_ = 1184,                    /* -save-temps= */
  OPT_shared = 1185,                         /* -shared */
  OPT_shared_libgcc = 1186,                  /* -shared-libgcc */
  /* OPT_specs = 1187, */                    /* -specs */
  OPT_specs_ = 1188,                         /* -specs= */
  OPT_static = 1189,                         /* -static */
  OPT_static_libasan = 1190,                 /* -static-libasan */
  OPT_static_libgcc = 1191,                  /* -static-libgcc */
  OPT_static_libgcj = 1192,                  /* -static-libgcj */
  OPT_static_libgfortran = 1193,             /* -static-libgfortran */
  OPT_static_libgo = 1194,                   /* -static-libgo */
  OPT_static_liblsan = 1195,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1196,               /* -static-libstdc++ */
  OPT_static_libtsan = 1197,                 /* -static-libtsan */
  OPT_static_libubsan = 1198,                /* -static-libubsan */
  /* OPT_std_c__03 = 1199, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1200, */                /* -std=c++0x */
  OPT_std_c__11 = 1201,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1202, */                /* -std=c++14 */
  OPT_std_c__1y = 1203,                      /* -std=c++1y */
  OPT_std_c__98 = 1204,                      /* -std=c++98 */
  OPT_std_c11 = 1205,                        /* -std=c11 */
  /* OPT_std_c1x = 1206, */                  /* -std=c1x */
  /* OPT_std_c89 = 1207, */                  /* -std=c89 */
  OPT_std_c90 = 1208,                        /* -std=c90 */
  OPT_std_c99 = 1209,                        /* -std=c99 */
  /* OPT_std_c9x = 1210, */                  /* -std=c9x */
  OPT_std_f2003 = 1211,                      /* -std=f2003 */
  OPT_std_f2008 = 1212,                      /* -std=f2008 */
  OPT_std_f2008ts = 1213,                    /* -std=f2008ts */
  OPT_std_f95 = 1214,                        /* -std=f95 */
  OPT_std_gnu = 1215,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1216, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1217, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1218,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1219, */              /* -std=gnu++14 */
